    ...
    <SafeAreaView style={styles.MainArea}>
      ...
      <ScrollView style={styles.ScrollArea}>
        {allUsers.map(function (user: any) {
          ...
          let counter = 0;
          return user.img.map(function (item: any) {
            //console.log(item)
            ...
            return (
              <View
                ...
                key={user.id * 100 + user.img.length - counter}>
      ...
      <View style={styles.Fotter}>
        <TouchableOpacity onPress={() => navigation.navigate('AddPhoto')}>
          <Image
            ...
            source={{
              uri: 'https://w7.pngwing.com/pngs/272/936/png-transparent-computer-icons-desktop-plus-and-minus-signs-restart-miscellaneous-sign-internet.png',
            }}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Profile')}>
          <Image
            ...
            source={{
              uri: 'https://e7.pngegg.com/pngimages/52/368/png-clipart-user-profile-computer-icons-avatar-avatar-heroes-monochrome.png',
            }}
          />
        </TouchableOpacity>
      </View>
